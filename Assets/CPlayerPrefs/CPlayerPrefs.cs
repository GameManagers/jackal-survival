...
public static class CPlayerPrefs
{
    ...
    public static bool HasKey(string key)
    {
        ...
        return PlayerPrefsP.HasKey(cKey);
    }
    ...
    public static void DeleteKey(string key)
    {
        // Get hashed key
        string cKey = hashedKey(key);
        CodeStage.AntiCheat.ObscuredTypes.ObscuredPrefs.DeleteKey(cKey);
    }
    ...
    public static void SetInt(string key, int val)
    {
        ...
        {
            // Save
            PlayerPrefsP.SetString(cKey, encrypt(cKey, string.Empty + cryptedInt));
        }
        else
        {
            PlayerPrefsP.SetInt(cKey, cryptedInt);
        }
    ...
    public static void SetString(string key, string val)
    {
        ...
        {
            // Save
            PlayerPrefsP.SetString(cKey, encrypt(cKey, cryptedString));
        }
        else
        {
            PlayerPrefsP.SetString(cKey, cryptedString);
        }
    }
    ...
    public static int GetInt(string key, int defaultValue)
    {
        ...
        {
            storedPref = PlayerPrefsP.GetInt(cKey);
        }
    ...
    public static string GetString(string key, string defaultValue)
    {
        ...
        {
            storedPref = PlayerPrefsP.GetString(cKey);
        }
    ...
    public static float GetFloat(string key, float defaultValue)
    {
        ...
        if (value.Contains(","))
            value = value.Replace(",", ".");
        float tmpFloat = float.Parse(value, System.Globalization.CultureInfo.InvariantCulture);
        return tmpFloat;
    ...
    {
        PlayerPrefsP.SetString(key, DoubleToString(value));
    }

    public static double GetDouble(string key, double defaultValue)
    {
        string defaultVal = DoubleToString(defaultValue);
        return StringToDouble(PlayerPrefsP.GetString(key, defaultVal));
    }
    ...
    {
        return ZKW.CryptoPlayerPrefs.Helper.DecryptString(PlayerPrefsC.GetString(cKey), getEncryptionPassword(cKey));
    }
